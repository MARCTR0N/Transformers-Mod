...
public class TFItemRenderer extends ItemRenderer{
	...
	public TFItemRenderer(Minecraft mcIn) {
		super(mcIn);
		this.mc = mcIn;
...
//	@Override
	private void rotateArm(float p_187458_1_)
    {
        ...
        GlStateManager.rotate((entityplayersp.rotationPitch - f) * 0.1F, 1.0F, 0.0F, 0.0F *2);
        GlStateManager.rotate((entityplayersp.rotationYaw - f1) * 0.1F, 0.0F, 1.0F, 0.0F *2);
    }
}
