...
public abstract class PlayerInv implements ICriterionTrigger<InventoryChangeTrigger.Instance>{

	
	private static final ResourceLocation ID = new ResourceLocation("inventory_changed");
    private final Map<PlayerAdvancements, PlayerInv.Listeners> listeners = Maps.<PlayerAdvancements, PlayerInv.Listeners>newHashMap();
    ...
    public void addListener(PlayerAdvancements playerAdvancementsIn, ICriterionTrigger.Listener<InventoryChangeTrigger.Instance> listener, RenderLivingEvent.Pre event )
    {
    	PlayerInv.Listeners inventorychangetrigger$listeners = this.listeners.get(playerAdvancementsIn);
    	...
    	if (entity instanceof EntityPlayer) {
            ...
            for (ItemStack stack : player.getArmorInventoryList()) {
    			if (stack.getItem() instanceof ItemArmorTransformer) {
    				 inventorychangetrigger$listeners = new PlayerInv.Listeners(playerAdvancementsIn);
    ...
    {
    	PlayerInv.Listeners inventorychangetrigger$listeners = this.listeners.get(player.getAdvancements());
