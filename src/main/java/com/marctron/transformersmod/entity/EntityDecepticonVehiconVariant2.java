...
public class EntityDecepticonVehiconVariant2 extends EntityDecepticon implements IAnimatedEntity{

	

//	public ControlledAnimation walkAnim = new ControlledAnimation(10);

public EntityDecepticonVehiconVariant2(World world) 
{
	super(world);
	...
	tasks.addTask(1, new AnimationAI<EntityDecepticonVehiconVariant2>(this) 
	{
		{
			setMutexBits(8);
		}
