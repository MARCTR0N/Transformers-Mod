...
import com.marctron.transformersmod.blocks.machinery.energycell.EnergyCellTile;
...
//				return;
//			PacketHandler.INSTANCE.sendTo(new PacketReturnEnergyDifference(((EnergyCellTile) te).energyDifference,
