...
public class RegistryHandler {
	...
	public static final ArmorMaterial DRAGSTRIP_MATERIAL = EnumHelper.addArmorMaterial("dragstrip_model",
			Reference.MOD_ID + ":dragstrip_model", 10, new int[] { 3, 3, 3, 3 }, 0,
			SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2.0F);

	public static final ArmorMaterial DEADEND_MATERIAL = EnumHelper.addArmorMaterial("deadend_model",
			Reference.MOD_ID + ":deadend_model", 10, new int[] { 3, 3, 3, 3 }, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,
			2.0F);

	public static final ArmorMaterial MOTORMASTER_MATERIAL = EnumHelper.addArmorMaterial("motormaster_model",
			Reference.MOD_ID + ":motormaster_model", 10, new int[] { 3, 3, 3, 3 }, 0,
			SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2.0F);

	public static final ArmorMaterial MENASOR_MATERIAL = EnumHelper.addArmorMaterial("menasor_model",
			Reference.MOD_ID + ":menasor_model", 10, new int[] { 3, 3, 3, 3 }, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,
			2.0F);

	public static final ArmorMaterial CUSTOM_MODEL_MATERIAL = EnumHelper.addArmorMaterial("custom_model",
			Reference.MOD_ID + ":custom_model", 10, new int[] { 3, 3, 3, 3 }, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,
			2.0F);

	public static final ArmorMaterial VURP_MATERIAL = EnumHelper.addArmorMaterial("vurp_model",
			Reference.MOD_ID + ":vurp_model", 10, new int[] { 3, 3, 3, 3 }, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,
			2.0F);
	public static final ArmorMaterial SUBWOOFER_MATERIAL = EnumHelper.addArmorMaterial("subwoofer_model",
			Reference.MOD_ID + ":subwoofer_model", 10, new int[] { 3, 3, 3, 3 }, 0,
			SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2.0F);

	public static final ArmorMaterial TARN_MODEL_MATERIAL = EnumHelper.addArmorMaterial("tarn_model",
			Reference.MOD_ID + ":tarn_model", 20, new int[] { 7, 8, 8, 9 }, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,
			2.0F);
	public static final ArmorMaterial TARN2_MODEL_MATERIAL = EnumHelper.addArmorMaterial("tarn2_model",
			Reference.MOD_ID + ":tarn2_model", 20, new int[] { 7, 8, 8, 9 }, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,
			2.0F);
	public static final ArmorMaterial TARN_ALTMODE_MATERIAL = EnumHelper.addArmorMaterial("tarn_altmode_model",
			Reference.MOD_ID + ":tarn_altmode_model", 20, new int[] { 7, 8, 8, 9 }, 0,
			SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2.0F);

	public static final ArmorMaterial STARSCREAM_MODEL_MATERIAL = EnumHelper.addArmorMaterial("starscream_model",
			Reference.MOD_ID + ":starscream_model", 20, new int[] { 7, 8, 8, 9 }, 0,
			SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2.0F);

	public static final ArmorMaterial MOVIE_OPTIMUS_PRIME_MATERIAL = EnumHelper.addArmorMaterial(
			"movie_optimus_prime_model", Reference.MOD_ID + ":movie_optimus_prime_model", 1000,
			new int[] { 7, 8, 8, 9 }, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2.0F);

	public static final ArmorMaterial SKYWARP_MODEL_MATERIAL = EnumHelper.addArmorMaterial("skywarp_model",
			Reference.MOD_ID + ":skywarp_model", 20, new int[] { 7, 8, 8, 9 }, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,
			2.0F);

	public static final ArmorMaterial THUNDERCRACKER_MODEL_MATERIAL = EnumHelper.addArmorMaterial(
			"thundercracker_model", Reference.MOD_ID + ":thundercracker_model", 20, new int[] { 7, 8, 8, 9 }, 0,
			SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2.0F);

	public static final ArmorMaterial SIDESWIPE_MODEL_MATERIAL = EnumHelper.addArmorMaterial("sideswipe_model",
			Reference.MOD_ID + ":sideswipe_model", 20, new int[] { 7, 8, 8, 9 }, 0,
			SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2.0F);

	public static final ArmorMaterial IRONHIDE_MATERIAL = EnumHelper.addArmorMaterial("ironhide_model",
			Reference.MOD_ID + ":ironhide_model", 20, new int[] { 7, 8, 8, 9 }, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,
			2.0F);

	public static final ArmorMaterial MAGNUS_MATERIAL = EnumHelper.addArmorMaterial("magnus_model",
			Reference.MOD_ID + ":magnus_model", 20, new int[] { 7, 8, 8, 9 }, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,
			2.0F);

	public static final ArmorMaterial MEGATRON_MATERIAL = EnumHelper.addArmorMaterial("megatron_model",
			Reference.MOD_ID + ":megatron_model", 20, new int[] { 7, 8, 8, 9 }, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,
			2.0F);

	// Armor Altmode
	public static final ArmorMaterial VEHICON_ALTMODE_MATERIAL = EnumHelper.addArmorMaterial("vehicon_altmode_model",
			Reference.MOD_ID + ":vehicon_altmode_model", 20, new int[] { 5, 5, 5, 5 }, 0,
			SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2.0F);

	public static final ArmorMaterial SIDESWIPE_ALTMODE_MATERIAL = EnumHelper.addArmorMaterial(
			"sideswipe_altmode_model", Reference.MOD_ID + ":sideswipe_altmode_model", 20, new int[] { 5, 5, 5, 5 }, 0,
			SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2.0F);

	public static final ArmorMaterial SKYWARP_ALTMODE_MATERIAL = EnumHelper.addArmorMaterial("skywarp_altmode_model",
			Reference.MOD_ID + ":skywarp_altmode_model", 20, new int[] { 7, 8, 8, 9 }, 0,
			SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2.0F);
	...
	public static class Registry {
		...
		public static void onItemRegister(RegistryEvent.Register<Item> event) {
			...
			final Item[] items = {
					...
					// OBJ
					new ACHILLESA4("achillesa4"), new DARKSTARSABER("darkstarsaber"),
					...
					// Relics
					new ItemStarSaber("star_saber", 200, SWORD_MATERIAL), new ItemPhaseShifter("phase_shifter"),
					...
					new ItemBase("protoform_legs"), new ItemBase("protoform_feet"), new ItemBase("spark"),
					new ItemBase("optics"), new ItemBase("voicebox"), new ItemBase("brain"), new ItemBase("hand"),
					new ItemBase("limb"), new ItemBase("spark_chamber"), new ItemBase("transformation_cog"),
					new ItemBase("autobot_insignia"), new ItemBase("decepticon_insignia"), new ItemBase("a_i"),
					new ItemBase("d_i"), new ItemBase("advanced_circuit"), new ItemBase("basic_circuit"),
					new ItemBase("alloy"), new ItemBase("cockpit"), new ItemBase("wing"), new ItemBase("tread"),
					new ItemBase("tire"), new ItemBase("wheel"), new ItemBase("hubcap"), new ItemBase("thruster"),
					new ItemBase("credit1"), new ItemBase("credit5"), new ItemBase("credit10"),
...
//					new RocketLauncher(50),
					...
					new ItemBase("mug"), new ItemEnergonMug("energon_mug", 4, false),
					...
					new ItemBase("transformium"), new ItemBase("silicon"),
					...
					new TFPMagnusAltmode("ultra_magnus_chestplate_altmode", MAGNUS_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					...
					new TarnAltmode("tarn_altmode_chestplate", 3000, TARN_ALTMODE_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					...
					new VehiconAltmode("vehicon_altmode_chestplate", VEHICON_ALTMODE_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new VehiconAltmode("vehicon_altmode_leggings", VEHICON_ALTMODE_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					...
					new SideswipeMid2("sideswipe_mid2_chestplate", SIDESWIPE_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					...
					new SideswipeMid3("sideswipe_mid3_chestplate", SIDESWIPE_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					...
					new SideswipeMid4("sideswipe_mid4_chestplate", SIDESWIPE_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					...
					new SideswipeAltmode("sideswipe_altmode_helmet", SIDESWIPE_ALTMODE_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new SideswipeAltmode("sideswipe_altmode_chestplate", SIDESWIPE_ALTMODE_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new SideswipeAltmode("sideswipe_altmode_leggings", SIDESWIPE_ALTMODE_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new SideswipeAltmode("sideswipe_altmode_boots", SIDESWIPE_ALTMODE_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					// Movie Optimus Prime
					// Stealth
					new MovieOptimusPrimeAltmodeWeaponized("movie_optimus_prime_altmode_weaponized_helmet",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 1, EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeAltmodeWeaponized("movie_optimus_prime_altmode_weaponized_chestplate",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 1, EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeAltmodeWeaponized("movie_optimus_prime_altmode_weaponized_leggings",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 2, EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeAltmodeWeaponized("movie_optimus_prime_altmode_weaponized_boots",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 1, EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeAltmodeWeaponizedMid1("movie_optimus_prime_altmode_weaponized_mid1_helmet",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 1, EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeAltmodeWeaponizedMid1("movie_optimus_prime_altmode_weaponized_mid1_chestplate",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 1, EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeAltmodeWeaponizedMid1("movie_optimus_prime_altmode_weaponized_mid1_leggings",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 2, EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeAltmodeWeaponizedMid1("movie_optimus_prime_altmode_weaponized_mid1_boots",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 1, EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeAltmodeWeaponizedMid2("movie_optimus_prime_altmode_weaponized_mid2_helmet",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 1, EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeAltmodeWeaponizedMid2("movie_optimus_prime_altmode_weaponized_mid2_chestplate",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 1, EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeAltmodeWeaponizedMid2("movie_optimus_prime_altmode_weaponized_mid2_leggings",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 2, EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeAltmodeWeaponizedMid2("movie_optimus_prime_altmode_weaponized_mid2_boots",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 1, EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeAltmodeWeaponizedMid3("movie_optimus_prime_altmode_weaponized_mid3_helmet",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 1, EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeAltmodeWeaponizedMid3("movie_optimus_prime_altmode_weaponized_mid3_chestplate",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 1, EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeAltmodeWeaponizedMid3("movie_optimus_prime_altmode_weaponized_mid3_leggings",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 2, EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeAltmodeWeaponizedMid3("movie_optimus_prime_altmode_weaponized_mid3_boots",
							MOVIE_OPTIMUS_PRIME_MATERIAL, 1, EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeAltmode2("movie_optimus_prime_helmet", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeAltmode2("movie_optimus_prime_chestplate", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeAltmode2("movie_optimus_prime_leggings", MOVIE_OPTIMUS_PRIME_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeAltmode2("movie_optimus_prime_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeAltmode("movie_optimus_prime_altmode_helmet", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeAltmode("movie_optimus_prime_altmode_chestplate", MOVIE_OPTIMUS_PRIME_MATERIAL,
							1, EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeAltmode("movie_optimus_prime_altmode_leggings", MOVIE_OPTIMUS_PRIME_MATERIAL,
							2, EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeAltmode("movie_optimus_prime_altmode_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeMid1("movie_optimus_prime_mid1_helmet", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeMid1("movie_optimus_prime_mid1_chestplate", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeMid1("movie_optimus_prime_mid1_leggings", MOVIE_OPTIMUS_PRIME_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeMid1("movie_optimus_prime_mid1_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeMid2("movie_optimus_prime_mid2_helmet", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeMid2("movie_optimus_prime_mid2_chestplate", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeMid2("movie_optimus_prime_mid2_leggings", MOVIE_OPTIMUS_PRIME_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeMid2("movie_optimus_prime_mid2_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeMid3("movie_optimus_prime_mid3_helmet", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeMid3("movie_optimus_prime_mid3_chestplate", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeMid3("movie_optimus_prime_mid3_leggings", MOVIE_OPTIMUS_PRIME_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeMid3("movie_optimus_prime_mid3_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeMid4("movie_optimus_prime_mid4_helmet", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeMid4("movie_optimus_prime_mid4_chestplate", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeMid4("movie_optimus_prime_mid4_leggings", MOVIE_OPTIMUS_PRIME_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeMid4("movie_optimus_prime_mid4_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeMid5("movie_optimus_prime_mid5_helmet", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeMid5("movie_optimus_prime_mid5_chestplate", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeMid5("movie_optimus_prime_mid5_leggings", MOVIE_OPTIMUS_PRIME_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeMid5("movie_optimus_prime_mid5_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeMid6("movie_optimus_prime_mid6_helmet", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeMid6("movie_optimus_prime_mid6_chestplate", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeMid6("movie_optimus_prime_mid6_leggings", MOVIE_OPTIMUS_PRIME_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeMid6("movie_optimus_prime_mid6_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeMid7("movie_optimus_prime_mid7_helmet", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeMid7("movie_optimus_prime_mid7_chestplate", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeMid7("movie_optimus_prime_mid7_leggings", MOVIE_OPTIMUS_PRIME_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeMid7("movie_optimus_prime_mid7_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeMid8("movie_optimus_prime_mid8_helmet", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeMid8("movie_optimus_prime_mid8_chestplate", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeMid8("movie_optimus_prime_mid8_leggings", MOVIE_OPTIMUS_PRIME_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeMid8("movie_optimus_prime_mid8_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeMid9("movie_optimus_prime_mid9_helmet", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new MovieOptimusPrimeMid9("movie_optimus_prime_mid9_chestplate", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new MovieOptimusPrimeMid9("movie_optimus_prime_mid9_leggings", MOVIE_OPTIMUS_PRIME_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new MovieOptimusPrimeMid9("movie_optimus_prime_mid9_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new MovieOptimusPrimeBack1("movie_optimus_prime_back1_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),
					new MovieOptimusPrimeBack2("movie_optimus_prime_back2_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),
					new MovieOptimusPrimeBack3("movie_optimus_prime_back3_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),
					new MovieOptimusPrimeBack4("movie_optimus_prime_back4_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),
					new MovieOptimusPrimeBack5("movie_optimus_prime_back5_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),
					new MovieOptimusPrimeBack6("movie_optimus_prime_back6_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),
					new MovieOptimusPrimeBack7("movie_optimus_prime_back7_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),
					new MovieOptimusPrimeBack8("movie_optimus_prime_back8_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),
					new MovieOptimusPrimeBack9("movie_optimus_prime_back9_boots", MOVIE_OPTIMUS_PRIME_MATERIAL, 1,
							EntityEquipmentSlot.FEET),
					...
					new StarscreamMid1("starscream_mid1_helmet", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamMid1("starscream_mid1_chestplate", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamMid1("starscream_mid1_leggings", STARSCREAM_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new StarscreamMid1("starscream_mid1_boots", STARSCREAM_MODEL_MATERIAL, 1, EntityEquipmentSlot.FEET),

					new StarscreamMid2("starscream_mid2_helmet", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamMid2("starscream_mid2_chestplate", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamMid2("starscream_mid2_leggings", STARSCREAM_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new StarscreamMid2("starscream_mid2_boots", STARSCREAM_MODEL_MATERIAL, 1, EntityEquipmentSlot.FEET),

					new StarscreamMid3("starscream_mid3_helmet", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamMid3("starscream_mid3_chestplate", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamMid3("starscream_mid3_leggings", STARSCREAM_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new StarscreamMid3("starscream_mid3_boots", STARSCREAM_MODEL_MATERIAL, 1, EntityEquipmentSlot.FEET),

					new StarscreamAltmode("starscream_altmode_helmet", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamAltmode("starscream_altmode_chestplate", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamAltmode("starscream_altmode_leggings", STARSCREAM_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new StarscreamAltmode("starscream_altmode_boots", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new StarscreamMid4("starscream_mid4_helmet", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamMid4("starscream_mid4_chestplate", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamMid4("starscream_mid4_leggings", STARSCREAM_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new StarscreamMid4("starscream_mid4_boots", STARSCREAM_MODEL_MATERIAL, 1, EntityEquipmentSlot.FEET),

					new StarscreamMid5("starscream_mid5_helmet", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamMid5("starscream_mid5_chestplate", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamMid5("starscream_mid5_leggings", STARSCREAM_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new StarscreamMid5("starscream_mid5_boots", STARSCREAM_MODEL_MATERIAL, 1, EntityEquipmentSlot.FEET),

					new StarscreamMid6("starscream_mid6_helmet", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamMid6("starscream_mid6_chestplate", STARSCREAM_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamMid6("starscream_mid6_leggings", STARSCREAM_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					...
					new StarscreamAltmode("skywarp_altmode_helmet", SKYWARP_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamAltmode("skywarp_altmode_chestplate", SKYWARP_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamAltmode("skywarp_altmode_leggings", SKYWARP_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					...
					new Starscream("thundercracker_chestplate", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new Starscream("thundercracker_leggings", THUNDERCRACKER_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new Starscream("thundercracker_boots", THUNDERCRACKER_MODEL_MATERIAL, 1, EntityEquipmentSlot.FEET),

					new StarscreamMid1("thundercracker_mid1_helmet", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamMid1("thundercracker_mid1_chestplate", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamMid1("thundercracker_mid1_leggings", THUNDERCRACKER_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new StarscreamMid1("thundercracker_mid1_boots", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new StarscreamMid2("thundercracker_mid2_helmet", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamMid2("thundercracker_mid2_chestplate", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamMid2("thundercracker_mid2_leggings", THUNDERCRACKER_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new StarscreamMid2("thundercracker_mid2_boots", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new StarscreamMid3("thundercracker_mid3_helmet", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamMid3("thundercracker_mid3_chestplate", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamMid3("thundercracker_mid3_leggings", THUNDERCRACKER_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new StarscreamMid3("thundercracker_mid3_boots", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new StarscreamAltmode("thundercracker_altmode_helmet", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamAltmode("thundercracker_altmode_chestplate", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamAltmode("thundercracker_altmode_leggings", THUNDERCRACKER_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new StarscreamAltmode("thundercracker_altmode_boots", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new StarscreamMid4("thundercracker_mid4_helmet", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamMid4("thundercracker_mid4_chestplate", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamMid4("thundercracker_mid4_leggings", THUNDERCRACKER_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new StarscreamMid4("thundercracker_mid4_boots", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new StarscreamMid5("thundercracker_mid5_helmet", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamMid5("thundercracker_mid5_chestplate", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamMid5("thundercracker_mid5_leggings", THUNDERCRACKER_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new StarscreamMid5("thundercracker_mid5_boots", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.FEET),

					new StarscreamMid6("thundercracker_mid6_helmet", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.HEAD),
					new StarscreamMid6("thundercracker_mid6_chestplate", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.CHEST),
					new StarscreamMid6("thundercracker_mid6_leggings", THUNDERCRACKER_MODEL_MATERIAL, 2,
							EntityEquipmentSlot.LEGS),
					new StarscreamMid6("thundercracker_mid6_boots", THUNDERCRACKER_MODEL_MATERIAL, 1,
							EntityEquipmentSlot.FEET),
...
//            		registerEntity("playerdummy", EntityPlayerDummy.class, Reference.ENTITY_PLAYER_DUMMY, 1, true),
		...
		public static void registerItemBlock(Block block) {
			...
			try {
				...
				Main.logger.fatal("Attempted to register itemblock for {} after PMC registration was complete!",
						block.getRegistryName());
			}
		}

		public static EntityEntry registerProjectile(String name, Class<? extends Entity> entity, int id,
				int trackRange, int frequency, boolean velocityUpdates) {
			return createEntityBuilder(name).entity(entity).id(new ResourceLocation(Reference.MOD_ID + ":" + name), 2)
					.tracker(trackRange, frequency, velocityUpdates).build();
		}

		private static EntityEntry registerEntity(String name, Class<? extends Entity> cl, int trackRange,
				int frequency, boolean velocityUpdates) {
			return createEntityBuilder(name).entity(cl).tracker(trackRange, frequency, velocityUpdates).build();
		}

		private static EntityEntry registerEntity(String name, Class<? extends Entity> entityClass, int trackingRange,
				int updateFrequency, boolean sendVelocityUpdates, int eggPrimary, int eggSecondary) {
			return createEntityBuilder(name).entity(entityClass)
					.tracker(trackingRange, updateFrequency, sendVelocityUpdates).egg(eggPrimary, eggSecondary).build();
		}
	...
	public static class ModelRegistry {
		...
		public static void onModelRegister(ModelRegistryEvent event) {
			ForgeRegistries.BLOCKS.getValuesCollection().stream()
					.filter(block -> block.getRegistryName().getResourceDomain().equals(Reference.MOD_ID))
					.forEach(block -> {
			...
			ForgeRegistries.ITEMS.getValuesCollection().stream()
					...
					.forEach(item -> {
						Main.logger.info("Registering model for " + item.getUnlocalizedName());
