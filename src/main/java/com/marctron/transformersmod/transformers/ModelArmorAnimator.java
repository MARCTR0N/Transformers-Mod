...
public class ModelArmorAnimator {
     ...
     */
    public static ModelArmorAnimator create() {
        return new ModelArmorAnimator();
    }

    /**
     * @return the {@link IAnimatedEntity} instance. Null if {@link ModelAnimator#update} has never been called.
     */
    public IAnimatedArmor getEntity() {
        return this.entity;
    }
     ...
     */
    public void update(IAnimatedArmor entity) {
