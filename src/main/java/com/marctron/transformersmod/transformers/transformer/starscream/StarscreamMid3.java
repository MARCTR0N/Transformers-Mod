...
public class StarscreamMid3 extends ItemArmorTransformer {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                if (world.isRemote) {
                    ...
                    if (itemStack.getItem() == RegistryHandler.ModItems.STARSCREAM_MID3_BOOTS) {
                        if (world.isRemote) {
                            player.inventory.armorInventory.set(0, new ItemStack(RegistryHandler.ModItems.STARSCREAM_ALTMODE_BOOTS));
                        }
                    }

                    if (itemStack.getItem() == RegistryHandler.ModItems.STARSCREAM_MID3_LEGGINGS) {
                        if (world.isRemote) {
                            player.inventory.armorInventory.set(1, new ItemStack(RegistryHandler.ModItems.STARSCREAM_ALTMODE_LEGGINGS));
                        }
                    }

                    if (itemStack.getItem() == RegistryHandler.ModItems.STARSCREAM_MID3_CHESTPLATE) {
                        if (world.isRemote) {
                            player.inventory.armorInventory.set(2, new ItemStack(RegistryHandler.ModItems.STARSCREAM_ALTMODE_CHESTPLATE));
                        }
                    }

                    if (itemStack.getItem() == RegistryHandler.ModItems.STARSCREAM_MID3_HELMET) {
                        if (world.isRemote) {
                            player.inventory.armorInventory.set(3, new ItemStack(RegistryHandler.ModItems.STARSCREAM_ALTMODE_HELMET));
                        }
                    }
                    ...
                    if (itemStack.getItem() == RegistryHandler.ModItems.SKYWARP_MID3_BOOTS) {
                        if (world.isRemote) {
                            player.inventory.armorInventory.set(0, new ItemStack(RegistryHandler.ModItems.SKYWARP_ALTMODE_BOOTS));
                        }
                    }

                    if (itemStack.getItem() == RegistryHandler.ModItems.SKYWARP_MID3_LEGGINGS) {
                        if (world.isRemote) {
                            player.inventory.armorInventory.set(1, new ItemStack(RegistryHandler.ModItems.SKYWARP_ALTMODE_LEGGINGS));
                        }
                    }

                    if (itemStack.getItem() == RegistryHandler.ModItems.SKYWARP_MID3_CHESTPLATE) {
                        if (world.isRemote) {
                            player.inventory.armorInventory.set(2, new ItemStack(RegistryHandler.ModItems.SKYWARP_ALTMODE_CHESTPLATE));
                        }
                    }
                    ...
                    //THUNDERCRACKER
                    if (itemStack.getItem() == RegistryHandler.ModItems.THUNDERCRACKER_MID3_BOOTS) {
                        if (world.isRemote) {
                            player.inventory.armorInventory.set(0, new ItemStack(RegistryHandler.ModItems.THUNDERCRACKER_ALTMODE_BOOTS));
                        }
                    }

                    if (itemStack.getItem() == RegistryHandler.ModItems.THUNDERCRACKER_MID3_LEGGINGS) {
                        if (world.isRemote) {
                            player.inventory.armorInventory.set(1, new ItemStack(RegistryHandler.ModItems.THUNDERCRACKER_ALTMODE_LEGGINGS));
                        }
                    }

                    if (itemStack.getItem() == RegistryHandler.ModItems.THUNDERCRACKER_MID3_CHESTPLATE) {
                        if (world.isRemote) {
                            player.inventory.armorInventory.set(2, new ItemStack(RegistryHandler.ModItems.THUNDERCRACKER_ALTMODE_CHESTPLATE));
                        }
                    }

                    if (itemStack.getItem() == RegistryHandler.ModItems.THUNDERCRACKER_MID3_HELMET) {
                        if (world.isRemote) {
                            player.inventory.armorInventory.set(3, new ItemStack(RegistryHandler.ModItems.THUNDERCRACKER_ALTMODE_HELMET));
                        }
                    }
                }
