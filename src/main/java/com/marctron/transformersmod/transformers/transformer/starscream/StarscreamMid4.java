...
public class StarscreamMid4 extends ItemArmorTransformer {
    ...
    public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                //Starscream
                if (itemStack.getItem() == RegistryHandler.ModItems.STARSCREAM_MID4_BOOTS) {
                    if (world.isRemote) {
                        player.inventory.armorInventory.set(0, new ItemStack(RegistryHandler.ModItems.STARSCREAM_MID5_BOOTS));
                    }
                }

                if (itemStack.getItem() == RegistryHandler.ModItems.STARSCREAM_MID4_LEGGINGS) {
                    if (world.isRemote) {
                        player.inventory.armorInventory.set(1, new ItemStack(RegistryHandler.ModItems.STARSCREAM_MID5_LEGGINGS));
                    }
                }

                if (itemStack.getItem() == RegistryHandler.ModItems.STARSCREAM_MID4_CHESTPLATE) {
                    if (world.isRemote) {
                        player.inventory.armorInventory.set(2, new ItemStack(RegistryHandler.ModItems.STARSCREAM_MID5_CHESTPLATE));
                    }
                }

                if (itemStack.getItem() == RegistryHandler.ModItems.STARSCREAM_MID4_HELMET) {
                    if (world.isRemote) {
                        player.inventory.armorInventory.set(3, new ItemStack(RegistryHandler.ModItems.STARSCREAM_MID5_HELMET));
                    }
                }

                //Skywarp
                if (itemStack.getItem() == RegistryHandler.ModItems.SKYWARP_MID4_BOOTS) {
                    if (world.isRemote) {
                        player.inventory.armorInventory.set(0, new ItemStack(RegistryHandler.ModItems.SKYWARP_MID5_BOOTS));
                    }
                }

                if (itemStack.getItem() == RegistryHandler.ModItems.SKYWARP_MID4_LEGGINGS) {
                    if (world.isRemote) {
                        player.inventory.armorInventory.set(1, new ItemStack(RegistryHandler.ModItems.SKYWARP_MID5_LEGGINGS));
                    }
                }

                if (itemStack.getItem() == RegistryHandler.ModItems.SKYWARP_MID4_CHESTPLATE) {
                    if (world.isRemote) {
                        player.inventory.armorInventory.set(2, new ItemStack(RegistryHandler.ModItems.SKYWARP_MID5_CHESTPLATE));
                    }
                }

                if (itemStack.getItem() == RegistryHandler.ModItems.SKYWARP_MID4_HELMET) {
                    if (world.isRemote) {
                        player.inventory.armorInventory.set(3, new ItemStack(RegistryHandler.ModItems.SKYWARP_MID5_HELMET));
                    }
                }
                //THUNDERCRACKER
                if (itemStack.getItem() == RegistryHandler.ModItems.THUNDERCRACKER_MID4_BOOTS) {
                    if (world.isRemote) {
                        player.inventory.armorInventory.set(0, new ItemStack(RegistryHandler.ModItems.THUNDERCRACKER_MID5_BOOTS));
                    }
                }

                if (itemStack.getItem() == RegistryHandler.ModItems.THUNDERCRACKER_MID4_LEGGINGS) {
                    if (world.isRemote) {
                        player.inventory.armorInventory.set(1, new ItemStack(RegistryHandler.ModItems.THUNDERCRACKER_MID5_LEGGINGS));
                    }
                }

                if (itemStack.getItem() == RegistryHandler.ModItems.THUNDERCRACKER_MID4_CHESTPLATE) {
                    if (world.isRemote) {
                        player.inventory.armorInventory.set(2, new ItemStack(RegistryHandler.ModItems.THUNDERCRACKER_MID5_CHESTPLATE));
                    }
                }

                if (itemStack.getItem() == RegistryHandler.ModItems.THUNDERCRACKER_MID4_HELMET) {
                    if (world.isRemote) {
                        player.inventory.armorInventory.set(3, new ItemStack(RegistryHandler.ModItems.THUNDERCRACKER_MID5_HELMET));
                    }
                }
