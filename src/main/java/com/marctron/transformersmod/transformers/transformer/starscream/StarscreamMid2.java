...
public class StarscreamMid2 extends ItemArmorTransformer {
    ...
    public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _default) {
        ...
        if (!itemStack.isEmpty()) {
            ...
            if (itemStack.getItem() instanceof ItemArmor) {
            	...
            	ArmorTypes.modelStarscreamMid2.bipedHead.showModel = armorSlot == EntityEquipmentSlot.HEAD;
            	ArmorTypes.modelStarscreamMid2.bipedHeadwear.showModel = armorSlot == EntityEquipmentSlot.HEAD;
            	ArmorTypes.modelStarscreamMid2.bipedBody.showModel = (armorSlot == EntityEquipmentSlot.CHEST) || (armorSlot == EntityEquipmentSlot.CHEST);
            	ArmorTypes.modelStarscreamMid2.bipedRightArm.showModel = armorSlot == EntityEquipmentSlot.CHEST;
            	ArmorTypes.modelStarscreamMid2.bipedLeftArm.showModel = armorSlot == EntityEquipmentSlot.CHEST;
            	ArmorTypes.modelStarscreamMid2.bipedRightLeg.showModel = (armorSlot == EntityEquipmentSlot.LEGS);
            	ArmorTypes.modelStarscreamMid2.bipedLeftLeg.showModel = (armorSlot == EntityEquipmentSlot.LEGS);

            	ArmorTypes.modelStarscreamMid2.isSneak = _default.isSneak;
            	ArmorTypes.modelStarscreamMid2.isRiding = _default.isRiding;
            	ArmorTypes.modelStarscreamMid2.isChild = _default.isChild;
            	ArmorTypes.modelStarscreamMid2.rightArmPose = _default.rightArmPose;
            	ArmorTypes.modelStarscreamMid2.leftArmPose = _default.leftArmPose;

                return ArmorTypes.modelStarscreamMid2;
            }
        }
