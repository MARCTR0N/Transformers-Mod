...
public class MovieOptimusPrimeMid8 extends ItemArmor implements IHasModel {
...
//				}
						...
						timer.schedule(new TimerTask() {
							...
							public void run() {
								...
								if (world.isRemote)
								{
									...
									if (itemStack.getItem() == ModItems.MOVIE_OPTIMUS_PRIME_MID8_BOOTS) {
										
									player.inventory.armorInventory.set(0, new ItemStack(ModItems.MOVIE_OPTIMUS_PRIME_MID9_BOOTS));
										
									}
									
									if (itemStack.getItem() == ModItems.MOVIE_OPTIMUS_PRIME_MID8_LEGGINGS) {
										
									player.inventory.armorInventory.set(1, new ItemStack(ModItems.MOVIE_OPTIMUS_PRIME_MID9_LEGGINGS));
										
									}
									
									if (itemStack.getItem() == ModItems.MOVIE_OPTIMUS_PRIME_MID8_CHESTPLATE) {
										
									player.inventory.armorInventory.set(2, new ItemStack(ModItems.MOVIE_OPTIMUS_PRIME_MID9_CHESTPLATE));
										
									}
									
									if (itemStack.getItem() == ModItems.MOVIE_OPTIMUS_PRIME_MID8_HELMET) {
										
									player.inventory.armorInventory.set(3, new ItemStack(ModItems.MOVIE_OPTIMUS_PRIME_MID9_HELMET));
									}
	...
	private static ModelMovieOptimusPrimeMid8 model = new ModelMovieOptimusPrimeMid8();
