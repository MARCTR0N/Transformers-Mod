...
public class MovieOptimusPrimeAltmodeWeaponizedMid3 extends ItemArmorTransformer {
...
public MovieOptimusPrimeAltmodeWeaponizedMid3(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
			...
			if(itemStack.getItem() instanceof ItemArmor) 
				{
					...
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid3.bipedHead.showModel = armorSlot == EntityEquipmentSlot.HEAD;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid3.bipedHeadwear.showModel = armorSlot == EntityEquipmentSlot.HEAD;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid3.bipedBody.showModel = (armorSlot == EntityEquipmentSlot.CHEST) || (armorSlot == EntityEquipmentSlot.CHEST);
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid3.bipedRightArm.showModel = armorSlot == EntityEquipmentSlot.CHEST;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid3.bipedLeftArm.showModel = armorSlot == EntityEquipmentSlot.CHEST;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid3.bipedRightLeg.showModel = (armorSlot == EntityEquipmentSlot.LEGS);
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid3.bipedLeftLeg.showModel = (armorSlot == EntityEquipmentSlot.LEGS);

					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid3.isSneak = _default.isSneak;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid3.isRiding = _default.isRiding;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid3.isChild = _default.isChild;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid3.rightArmPose = _default.rightArmPose;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid3.leftArmPose = _default.leftArmPose;

					return ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid3;
				}
			}
