...
public class MovieOptimusPrimeMid1 extends ItemArmor implements IHasModel {
	

	

public MovieOptimusPrimeMid1(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
...
//				}
						...
						timer.schedule(new TimerTask() {
							...
							public void run() {
								...
								if (world.isRemote)
								{
									...
									if (itemStack.getItem() == ModItems.MOVIE_OPTIMUS_PRIME_MID1_BOOTS) {
										
									player.inventory.armorInventory.set(0, new ItemStack(ModItems.MOVIE_OPTIMUS_PRIME_MID2_BOOTS));
										
									}
									
									if (itemStack.getItem() == ModItems.MOVIE_OPTIMUS_PRIME_MID1_LEGGINGS) {
										
									player.inventory.armorInventory.set(1, new ItemStack(ModItems.MOVIE_OPTIMUS_PRIME_MID2_LEGGINGS));
										
									}
									
									if (itemStack.getItem() == ModItems.MOVIE_OPTIMUS_PRIME_MID1_CHESTPLATE) {
										
									player.inventory.armorInventory.set(2, new ItemStack(ModItems.MOVIE_OPTIMUS_PRIME_MID2_CHESTPLATE));
										
									}
									
									if (itemStack.getItem() == ModItems.MOVIE_OPTIMUS_PRIME_MID1_HELMET) {
										
									player.inventory.armorInventory.set(3, new ItemStack(ModItems.MOVIE_OPTIMUS_PRIME_MID2_HELMET));
									}
	...
	private static ModelMovieOptimusPrimeMid1 model = new ModelMovieOptimusPrimeMid1();
