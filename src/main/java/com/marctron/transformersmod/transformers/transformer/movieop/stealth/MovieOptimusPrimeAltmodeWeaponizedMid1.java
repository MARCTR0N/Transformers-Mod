...
public class MovieOptimusPrimeAltmodeWeaponizedMid1 extends ItemArmorTransformer {
...
public MovieOptimusPrimeAltmodeWeaponizedMid1(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
			...
			if(itemStack.getItem() instanceof ItemArmor) 
				{
					...
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid1.bipedHead.showModel = armorSlot == EntityEquipmentSlot.HEAD;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid1.bipedHeadwear.showModel = armorSlot == EntityEquipmentSlot.HEAD;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid1.bipedBody.showModel = (armorSlot == EntityEquipmentSlot.CHEST) || (armorSlot == EntityEquipmentSlot.CHEST);
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid1.bipedRightArm.showModel = armorSlot == EntityEquipmentSlot.CHEST;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid1.bipedLeftArm.showModel = armorSlot == EntityEquipmentSlot.CHEST;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid1.bipedRightLeg.showModel = (armorSlot == EntityEquipmentSlot.LEGS);
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid1.bipedLeftLeg.showModel = (armorSlot == EntityEquipmentSlot.LEGS);

					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid1.isSneak = _default.isSneak;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid1.isRiding = _default.isRiding;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid1.isChild = _default.isChild;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid1.rightArmPose = _default.rightArmPose;
					ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid1.leftArmPose = _default.leftArmPose;

					return ArmorTypes.modelMovieOptimusPrimeAltmodeWeaponizedMid1;
				}
			}
