...
public class MovieOptimusPrimeMid3 extends ItemArmor implements IHasModel {
	

	

public MovieOptimusPrimeMid3(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
...
//				}
						...
						timer.schedule(new TimerTask() {
							...
							public void run() {
								...
								if (world.isRemote)
								{
									...
									if (itemStack.getItem() == ModItems.MOVIE_OPTIMUS_PRIME_MID3_BOOTS) {
										
									player.inventory.armorInventory.set(0, new ItemStack(ModItems.MOVIE_OPTIMUS_PRIME_MID4_BOOTS));
										
									}
									
									if (itemStack.getItem() == ModItems.MOVIE_OPTIMUS_PRIME_MID3_LEGGINGS) {
										
									player.inventory.armorInventory.set(1, new ItemStack(ModItems.MOVIE_OPTIMUS_PRIME_MID4_LEGGINGS));
										
									}
									
									if (itemStack.getItem() == ModItems.MOVIE_OPTIMUS_PRIME_MID3_CHESTPLATE) {
										
									player.inventory.armorInventory.set(2, new ItemStack(ModItems.MOVIE_OPTIMUS_PRIME_MID4_CHESTPLATE));
										
									}
									
									if (itemStack.getItem() == ModItems.MOVIE_OPTIMUS_PRIME_MID3_HELMET) {
										
									player.inventory.armorInventory.set(3, new ItemStack(ModItems.MOVIE_OPTIMUS_PRIME_MID4_HELMET));
									}
	...
	private static ModelMovieOptimusPrimeMid3 model = new ModelMovieOptimusPrimeMid3();
