...
public class Subwoofer1 extends ItemArmorTransformer {

    

    public Subwoofer1(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
    ...
    public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _default) {
        ...
        if (!itemStack.isEmpty()) {
            ...
            if (itemStack.getItem() instanceof ItemArmor) {
            	...
            	ArmorTypes.modelSubwoofer1.bipedHead.showModel = armorSlot == EntityEquipmentSlot.HEAD;
                ArmorTypes.modelSubwoofer1.bipedHeadwear.showModel = armorSlot == EntityEquipmentSlot.HEAD;
                ArmorTypes.modelSubwoofer1.bipedBody.showModel = (armorSlot == EntityEquipmentSlot.CHEST) || (armorSlot == EntityEquipmentSlot.CHEST);
                ArmorTypes.modelSubwoofer1.bipedRightArm.showModel = armorSlot == EntityEquipmentSlot.CHEST;
                ArmorTypes.modelSubwoofer1.bipedLeftArm.showModel = armorSlot == EntityEquipmentSlot.CHEST;
                ArmorTypes.modelSubwoofer1.bipedRightLeg.showModel = (armorSlot == EntityEquipmentSlot.LEGS);
                ArmorTypes.modelSubwoofer1.bipedLeftLeg.showModel = (armorSlot == EntityEquipmentSlot.LEGS);

                ArmorTypes.modelSubwoofer1.isSneak = _default.isSneak;
                ArmorTypes.modelSubwoofer1.isRiding = _default.isRiding;
                ArmorTypes.modelSubwoofer1.isChild = _default.isChild;
                ArmorTypes.modelSubwoofer1.rightArmPose = _default.rightArmPose;
                ArmorTypes.modelSubwoofer1.leftArmPose = _default.leftArmPose;

                return ArmorTypes.modelSubwoofer1;
            }
        }
