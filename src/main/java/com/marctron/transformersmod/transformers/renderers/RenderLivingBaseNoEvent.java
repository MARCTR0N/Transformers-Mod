...
public abstract class RenderLivingBaseNoEvent<T extends EntityLivingBase> extends RenderLivingBase<T>
{
    private static final Logger LOGGER = LogManager.getLogger();
    private static final DynamicTexture TEXTURE_BRIGHTNESS = new DynamicTexture(16, 16);

    public RenderLivingBaseNoEvent(RenderManager renderManagerIn, ModelBase modelBaseIn, float shadowSizeIn)
    {
