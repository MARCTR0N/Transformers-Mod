...
import com.marctron.transformersmod.transformers.models.EmptyPlayerModel;
...
public class RenderArmorNoItem extends RenderLivingBaseNoEvent<AbstractClientPlayer>
{
    /** this field is used to indicate the 3-pixel wide arms */
    private final boolean smallArms;

    public RenderArmorNoItem(RenderManager renderManager)
    {
        this(renderManager, false);
    }

    public RenderArmorNoItem(RenderManager renderManager, boolean useSmallArms)
    {
        super(renderManager, new EmptyPlayerModel(0.0F, useSmallArms), 0.5F);
