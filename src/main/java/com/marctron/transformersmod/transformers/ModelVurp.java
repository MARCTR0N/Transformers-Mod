...
public class ModelVurp extends ModelBiped {
    ...
    public ModelVurp()
    {
        ...
        setRotateAngle(RightFoot_1, 0.0F, 0.0F, -0.017453292519943295F);
        ...
        RightLeg_1.setRotationPoint(0F, 0F, 0.1F);
        ...
        RightLeg.setRotationPoint(0F, 0F, 0.1F);
        ...
        RightArm.setRotationPoint(0F, 0F, 0.5F);
        ...
        RightArm_1.setRotationPoint(0F, 0F, 0.5F);
        ...
        setRotateAngle(RightFoot, 0.0F, 0.0F, 0.017453292519943295F);
        CHEST = new ModelRenderer(this, "CHEST").setTextureOffset(0, 0);
        CHEST.setRotationPoint(0.0F, 0.0F, 0.0F);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        this.RightLowerLeg.rotateAngleX = MathHelper.cos(limbSwing * 0.4662F ) * 1F * limbSwingAmount  ;
        this.RightLowerLeg_1.rotateAngleX = MathHelper.cos(limbSwing * 0.4662F ) * 1F * limbSwingAmount ;
        
        this.RightLeg.rotateAngleX = MathHelper.cos(limbSwing * 0.4662F) * .6F * limbSwingAmount  / 4;
        this.RightLeg_1.rotateAngleX = MathHelper.cos(limbSwing * 0.4662F + (float) Math.PI) * .6F * limbSwingAmount / 4;
        
        this.RightLowerLeg.rotateAngleX += 0.1;
        this.RightLowerLeg_1.rotateAngleX += 0.1;
        
        if (this.RightLowerLeg_1.rotateAngleX < 0){
        	this.RightLowerLeg_1.rotateAngleX = 0;
        }
        if (this.RightLowerLeg.rotateAngleX < 0){
...
//        lowerArmR.rotateAngleX -= 0.1;
        ...
        this.RightLowerArm.rotateAngleX = MathHelper.cos(limbSwing * 0.4662F) * .6F * limbSwingAmount  * 4;
        this.RightLowerArm_1.rotateAngleX = MathHelper.cos(limbSwing * 0.4662F + (float) Math.PI) * .6F * limbSwingAmount  * 4;
        
        
        this.RightLeg.rotateAngleX -= 0.1;
        this.RightLeg_1.rotateAngleX -= 0.1;
        
//        this.RightLowerLeg.rotateAngleX = 0.5F * globalSpeed( 1.2F * globalDegree, false, -2.2F * backwardInverter, 0.6F, limbSwing, limbSwingAmount);
	...
	private float globalSpeed(float f, boolean b, float g, float h, float limbSwing, float limbSwingAmount) {
