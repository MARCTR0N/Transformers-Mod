...
public class AdvancedModelBipedRenderer extends ModelRenderer {
    ...
    private AdvancedModelBiped model;
    private AdvancedModelBipedRenderer parent;
    private int displayList;
    private boolean compiled;

    public AdvancedModelBipedRenderer(AdvancedModelBiped model, String name) {
        super(model, name);
        this.model = model;
    }

    public AdvancedModelBipedRenderer(AdvancedModelBiped model) {
        this(model, null);
    }

    public AdvancedModelBipedRenderer(AdvancedModelBiped model, int textureOffsetX, int textureOffsetY) {
        this(model);
        this.setTextureOffset(textureOffsetX, textureOffsetY);
    }

    public AdvancedModelBipedRenderer add3DTexture(float posX, float posY, float posZ, int width, int height) {
    ...
    public void addChild(ModelRenderer child) {
        ...
        if (child instanceof AdvancedModelBipedRenderer) {
        	AdvancedModelBipedRenderer advancedChild = (AdvancedModelBipedRenderer) child;
     ...
     */
    public AdvancedModelBipedRenderer getParent() {
        return this.parent;
    }
     ...
     */
    public void setParent(AdvancedModelBipedRenderer parent) {
        this.parent = parent;
    }
    ...
    public AdvancedModelBiped getModel() {
        return this.model;
    }
    ...
    @Override
    public AdvancedModelBipedRenderer setTextureOffset(int textureOffsetX, int textureOffsetY) {
