...
public class AttachAttributes
{
	...
	public void onPlayerTick(TickEvent.PlayerTickEvent event)
	{
		...
		if(player.hasCapability(SizeLimitPro.sizeCapability, null))
		{
			final ISizeLimit cap = player.getCapability(SizeLimitPro.sizeCapability, null);
	...
	public void onLivingUpdate(LivingUpdateEvent event)
	{
		...
		{
			if(entity.hasCapability(SizeLimitPro.sizeCapability, null))
			{
				final ISizeLimit cap = entity.getCapability(SizeLimitPro.sizeCapability, null);
