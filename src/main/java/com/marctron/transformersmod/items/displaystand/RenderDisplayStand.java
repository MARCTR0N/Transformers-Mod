...
public class RenderDisplayStand extends RenderLivingBase<EntityDisplayStand>
{
    ...
    public RenderDisplayStand(RenderManager manager)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityDisplayStand entity)
    {
    ...
    protected void applyRotations(EntityDisplayStand entityLiving, float p_77043_2_, float rotationYaw, float partialTicks)
    {
    ...
    protected boolean canRenderName(EntityDisplayStand entity)
    {
     ...
     */
    public void doRender(EntityDisplayStand entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (entity.hasMarker())
        {
