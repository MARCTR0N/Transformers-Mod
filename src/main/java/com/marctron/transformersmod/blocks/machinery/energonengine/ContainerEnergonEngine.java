...
import com.marctron.transformersmod.blocks.machinery.SlotMachineFuel;
...
public class ContainerEnergonEngine extends Container {
	 ...
	 */
	public ContainerEnergonEngine(IInventory playerInv, EnergonEngineTile te) {
		this.te = te;
		this.handler = te.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null);

		this.addSlotToContainer(new SlotItemHandler(handler, 0, 81, 35));
