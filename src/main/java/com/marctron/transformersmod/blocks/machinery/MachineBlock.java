...
public class MachineBlock extends BlockContainer implements IMetaBlockName, ITileEntityProvider {
...
//		this.isBlockContainer = true;
	...
	public MachineBlock setEnergy(int energy, int capacity, int maxReceive, int maxExtract) {
		this.energy = energy;
...
////			stack = new ItemStack(new ItemBlockMachine(this), 1, world.getBlockState(pos).getValue(TYPE).getID(),te.getUpdateTag());
