...
public class ArmorModel2 extends ItemArmor implements IHasModel {

	public ArmorModel2(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
